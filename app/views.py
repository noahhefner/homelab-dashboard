...
def _static_assets():
    """Read the Vite-generated asset manifest.

    Returns paths relative to /static so they can be used directly by
    ...
    try:
        ...
        # Allow the application to render even when assets have not been built.
        return {
            "js_assets": [],
            "css_assets": [],
        }
    ...
    return {
        "js_assets": manifest.get("js", []),
        "css_assets": manifest.get("css", []),
    }
